...
{
    AwaStaticClient_DefineObject(awaClient, 3200, "Overflow Switch Input", 0, COUNTER_INSTANCES);
...
static void addcount(uint8_t event)
{
    if (event == 1)
    {
        currentcount++;
...
int main(void)
{
	...
	motion_click_attach_callback(MIKROBUS_1, addcount);
